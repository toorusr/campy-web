...
<div class="p-4 bg-purple">
    ...
    <div class="bg-white p-4">
        <dl class="mt-4 text-lg">
            ...
            <dt class="font-bold">Wie gelingt Lernen auf dem Camp?</dt>
            <dd class="mb-4">
                <ul>
                    ...
                    <li>Wir als Coaches sind Vorbilder in allem, was wir tun.</li>
                    ...
                    <li>Die Tastatur der Lernenden ist aus Lava. (Du verlierst die Lernenden, wenn du die Tastatur übernimmst).</li>
                </ul>
            </dd>
