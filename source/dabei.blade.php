...
<div class="p-4 bg-purple">
    <div class="bg-white p-4">
        ...
        <ul class="text-lg leading-loose">
           ...
           <li class="text-sm">Keine SMS bekommen und 24h durch? Bitte erinnere uns <a href="mailto:hello@code.design?subject=Erinnerung%20Anmeldung&amp;body=Hallo,%20ich%habe%20mich%20angemeldet%20und%20warte%20auf%20eine%20Ant">kurz per Mail :)</a></li>
        </ul>
