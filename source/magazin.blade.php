    ...
    <div class="p-8 rounded bg-white">
        ...
        <div class="mt-4">
            @component('_components.img')
                @slot('src') /img/magazin/magazin-002.jpg @endslot
                @slot('alt') Das Magazin #2 @endslot
            @endcomponent
            <div class="mt-4">
            ...
            <div class="mt-4">
                @component('_components.button')
                    @slot('link') files/code-design-magazine-002.pdf @endslot
                ...
                @component('_components.button')
                    @slot('colorback') purple @endslot
                    @slot('colorfront') white @endslot
                    @slot('link') magazin/bestellen @endslot
                    Kostenlos bestellen
                @endcomponent
            </div>
            <div class="mt-4">
...
-                   In fünf Schritten zur eigenen App
            ...
            <div class="mt-4">
                @component('_components.button')
                    @slot('link') files/code-design-magazine-001.pdf @endslot
                    @slot('colorback') purple @endslot
                    @slot('colorfront') white @endslot
                    <svg xmlns="http://www.w3.org/2000/svg" class="stroke-current w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-download"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="7 10 12 15 17 10"></polyline><line x1="12" y1="15" x2="12" y2="3"></line></svg> Download
                @endcomponent
