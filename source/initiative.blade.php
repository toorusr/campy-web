        				...
        				<div class="w-full h-full">
        					<div class="flex flex-row items-center justify-center">
        						@component('_components.img')
                                    @slot('src') /img/team/tom.jpg @endslot
                                    @slot('width') w-auto @endslot
                                    @slot('rounded') rounded-full @endslot
                                    @slot('alt') Tom Bachem @endslot
                                @endcomponent
        					</div>
        	...
        	<div class="md:w-1/5">
        		<div class="flex-1 h-full bg-grey-lighter p-4 rounded md:ml-1 mb-4">
        				<div class="w-full h-full">
        					<div class="flex flex-row items-center justify-center">
        						@component('_components.img')
                                    @slot('src') /img/team/manuel.jpg @endslot
                                    @slot('width') w-auto @endslot
                                    @slot('rounded') rounded-full @endslot
                                    @slot('alt') Manuel Dolderer @endslot
                                @endcomponent
        					</div>
        					<div class="h-full text-center">
        	...
        	<div class="md:w-1/5">
        		<div class="flex-1 h-full bg-grey-lighter p-4 rounded md:ml-2 mb-4">
        				<div class="w-full h-full">
        					<div class="flex flex-row items-center justify-center">
        						@component('_components.img')
                                    @slot('src') /img/team/ina.jpg @endslot
                                    @slot('width') w-auto @endslot
                                    @slot('rounded') rounded-full @endslot
                                    @slot('alt') Ina Wagner @endslot
                                @endcomponent
        					</div>
        					<div class="h-full text-center">
        	...
        	<div class="md:w-1/5">
        		<div class="flex-1 h-full bg-grey-lighter p-4 rounded md:ml-2 mb-4">
        				<div class="w-full h-full">
        					<div class="flex flex-row items-center justify-center">
        						@component('_components.img')
                                    @slot('src') /img/team/martin.jpg @endslot
                                    @slot('width') w-auto @endslot
                                    @slot('rounded') rounded-full @endslot
                                    @slot('alt') Martin Betz @endslot
                                @endcomponent
        					</div>
        					<div class="h-full text-center">
        	...
        	<div class="md:w-1/5">
        		<div class="flex-1 h-full bg-grey-lighter p-4 rounded md:ml-2 mb-4">
        				<div class="w-full h-full">
        					<div class="flex flex-row items-center justify-center">
        						@component('_components.img')
                                    @slot('src') /img/team/anna.jpg @endslot
                                    @slot('width') w-auto @endslot
                                    @slot('rounded') rounded-full
                                    @endslot @slot('alt') Anna Brückner @endslot
                                @endcomponent
        					</div>
        					<div class="h-full text-center">
