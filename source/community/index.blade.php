...
<div class="mt-8"><a href="https://docs.google.com/document/d/1apQKZKee2YmjpZtycIzNYRH0ZDkYqymgBLfcIsTHMxU/edit#bookmark=id.xsrxfeqs777z" target="_blank">@component('_components.img')
    @slot('src') /img/community/ladder.png @endslot
    @slot('alt') Community Programm Ladder @endslot
