...
<form class="w-full">
  <div class="flex flex-wrap -mx-3 mb-2">
    <div class="flex-1 px-3 mb-6 md:mb-0">
      ...
      <input class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded py-3 px-4" id="firstname" type="text" placeholder="Simone">
    </div>
    <div class="flex-1 px-3 mb-6 md:mb-0">
      <label class="block uppercase tracking-wide text-grey-darker text-xs font-bold mb-2" for="grid-zip">
        Email
      </label>
      <input class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded py-3 px-4" id="email" type="email" placeholder="robot@simonegiertz.com">
    </div>
    <div class="flex-1 px-3 mb-6 md:mb-0">
