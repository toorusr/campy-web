  ...
  <div class="md:w-1/2 h-auto md:mt-0 mt-8">
      ...
      <div class="mt-6"><a href="#" class="text-grey-darkest no-underline border-b-2 border-yellow">Unterstützen</a>
         <ul class="list-reset leading-normal mt-2">
           <li class="text-grey-darker"><a href="/coach">Coach auf Camp</a></li>
           <li class="text-grey-darker"><a href="/initiative/spenden">Spenden</a></li>
           <li class="text-grey-darker"><a href="#">Ehrenamtlich tätig werden</a></li>
         </ul>
      </div>
