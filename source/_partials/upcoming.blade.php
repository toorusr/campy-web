<div class="mt-4 border-2 rounded p-4 mb-4 bg-grey-light">
    ...
    <div class="md:flex md:flex-wrap">
        <p>
            Wir planen gerade unsere Aktivitäten für 2019! Sobald es Termine gibt, erfahrt ihr sie hier und im Newsletter
        </p>
            ...
            <div class="flex-1 p-1">
                <div class="flex flex-col flex-1 bg-grey-darkest p-4 rounded">
                    <a class="no-underline" href="{{ $camp->getPath() }}">
                        ...
                        <p class="text-white">
                            ({{ date('d.m.', $camp->date_start) }} bis {{ date('d.m.y', $camp->date_end) }})<br/>
                            {{ $camp->holidays }}
                        </p>
                    </a>
                </div>
